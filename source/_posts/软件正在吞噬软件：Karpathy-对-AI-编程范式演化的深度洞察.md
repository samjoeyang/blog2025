---
title: 软件正在吞噬软件：Karpathy 对 AI 编程范式演化的深度洞察
date: 2025-07-08 16:47:02
tags: [AI, 软件开发, Andrej Karpathy, 编程范式, LLM, 软件 2.0, 软件 3.0, Y Combinator, 演讲, 视频翻译, 技术演进]
---
...
> **视频链接**：[YouTube - Software 2.0 and 3.0](https://www.youtube.com/watch?v=LCEmiRjPEtQ)
...
> [🔗 观看原始演讲视频（英文）](https://www.youtube.com/watch?v=LCEmiRjPEtQ)
...
<details>
<summary>视频链接：https://www.youtube.com/watch?v=LCEmiRjPEtQ</summary>
...
他不再鼓励你死磕 API，而是鼓励你重拾语言、场景与合作。你不再是命令机器的工程师，而是**与机器共舞的导演、设计者、产品人**。

对于 AI 开发者、产品经理、设计师、内容创作者来说，这一变化意义深远：

* LLM 不是工具链的一部分，它**就是操作系统本身**；
...
> 📌 本文整理自 [Y Combinator YouTube 演讲](https://www.youtube.com/watch?v=LCEmiRjPEtQ) + \[翻译整理 by ChatGPT]
